...
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLCreateModel (
    const void* buffer,
    int32_t bufferSize,
...
/*!
 ...
 ML model.
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLReleaseModel (NMLModel* model);
#pragma endregion
...
*/
NML_BRIDGE NML_EXPORT int32_t NML_APIENTRY NMLModelGetMetadataCount (NMLModel* model);
...
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLModelGetMetadataKey (
    NMLModel* model,
    int32_t index,
    char* key,
    int32_t size
...
/*!
 ...
 Size of destination buffer.
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLModelGetMetadataValue (
    NMLModel* model,
    const char* key,
    char* value,
    int32_t size
...
*/
NML_BRIDGE NML_EXPORT int32_t NML_APIENTRY NMLModelGetInputFeatureCount (NMLModel* model);
...
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLModelGetInputFeatureType (
    NMLModel* model,
    int32_t index,
    NMLFeatureType** type
);
...
*/
NML_BRIDGE NML_EXPORT int32_t NML_APIENTRY NMLModelGetOutputFeatureCount (NMLModel* model);
...
/*!
 ...
 Output feature type. This type should be released once it is no longer in use.
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLModelGetOutputFeatureType (
    NMLModel* model,
    int32_t index,
    NMLFeatureType** type
);
...
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLModelPredict (
    NMLModel* model,
