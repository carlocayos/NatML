...
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLCreateModelOptions (NMLModelOptions** options);
...
/*!
 ...
 ML model options.
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLReleaseModelOptions (NMLModelOptions* options);
#pragma endregion
...
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLModelOptionsSetComputeTarget (
...
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLModelOptionsSetComputeDevice (
    NMLModelOptions* options,
    void* device
);
...
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLModelOptionsSetHubSessionFlags (
    NMLModelOptions* options,
    int32_t flags
);
#pragma endregion