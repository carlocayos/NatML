...
/*!
 ...
 Output frame count.
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLFeatureReaderGetVideoFormat (
    const char* path,
    int32_t* outWidth,
    int32_t* outHeight,
    int32_t* outFrames
...
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLFeatureReaderGetAudioFormat (
    const char* path,
...
/*!
 ...
 ML feature reader.
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLReleaseFeatureReader (NMLFeatureReader* reader);
...
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLFeatureReaderReadNextFeature (
...
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLCreateImageFeatureReader (
    const char* path,
    NMLFeatureReader** reader
);
...
/*!
 ...
 Output ML feature reader.
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLCreateAudioFeatureReader (
    const char* path,
    NMLFeatureReader** reader
);
#pragma endregion