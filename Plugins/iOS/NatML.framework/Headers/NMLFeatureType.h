...
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLReleaseFeatureType (NMLFeatureType* type);
...
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLFeatureTypeGetName (NMLFeatureType* type, char* name, int32_t size);
...
/*!
 ...
 ML feature type.
*/
NML_BRIDGE NML_EXPORT NMLDataType NML_APIENTRY NMLFeatureTypeGetDataType (NMLFeatureType* type);
...
/*!
 ...
 ML feature type.
*/
NML_BRIDGE NML_EXPORT int32_t NML_APIENTRY NMLFeatureTypeGetDimensions (NMLFeatureType* type);
...
*/
NML_BRIDGE NML_EXPORT void NML_APIENTRY NMLFeatureTypeGetShape (NMLFeatureType* type, int32_t* shape, int32_t shapeLen);
#pragma endregion