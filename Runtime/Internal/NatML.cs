...
namespace NatML.Internal {
    ...
    public static class NatML { // NatML.h
        ...
        public static unsafe extern void SetHubSessionFlags (
            this IntPtr options,
            int flags
        );

        [DllImport(Assembly, EntryPoint = @"NMLModelOptionsSetComputeTarget")]
        public static unsafe extern void SetComputeTarget (
            this IntPtr options,
            MLModelData.ComputeTarget target
        );

        [DllImport(Assembly, EntryPoint = @"NMLModelOptionsSetComputeDevice")]
        public static unsafe extern void SetComputeDevice (
            this IntPtr options,
            IntPtr device
        );
        #endregion
